      ...
      <v-row>
        <v-col cols="12" md="5" lg="5" sm="12">
          <div class="container">
            ...
            <div>
              <span>
                Total Pay Out: <strong>{{ total_amount }}</strong>
              </span>
              <br />
            </div>
            <div>
                      ...
                      >
                        <div class="text-center">
                          <v-btn
                            ...
                            "
                          >
                            <v-icon>mdi-delete</v-icon><span></span>
                          </v-btn>
                        </div>
                        <div id="clothImage">
        ...
        <v-col cols="12" md="12">
          <div class="container">
            ...
            >
              <div class="d-flex">
                <h4 style="margin: 4px">Checkout</h4>
          ...
          <v-card>
            <div class="">
              <div class="container">
                <div class="d-flex">
                  <div class="container">
                    <h4>Provide these to confirm you order</h4>
                  </div>
...
export default {
  ...
  methods: {
      ...
      if (
        ...
        db.collection("Order_request")
          ...
          .update({
            ...
            month: this.moment(new Date()).format("MMM YYYY"),
            cart: false,
            paid: true,
            Total: this.total_amount,
          })
    ...
    updateStatus4(val) {
      ...
      db.collection("My_Stock")
        ...
        .then((docRef) => {
          if (val == true) {
            this.snackbar = true;
            this.snackbarText = docRef;
          } else {
            this.snackbar = true;
            this.snackbarText = "Order sent";
            this.$router.push("/");
          }
        })
        .catch((error) => {
      ...
      db.collection("Order_request")
        ...
        .then((queryResult) => {
          queryResult.forEach((doc) => {
            ...
            this.updateStatus4(doc.data().item_id);
      ...
      db.collection("Order_request")
        ...
        .then((queryResult) => {
          queryResult.forEach((doc) => {
            ...
            this.DeleteList(doc.data().item_id);
          });
        });
    },
    ...
    async DeleteCartItem(val) {
      ...
      var cart_ref = db.collection("item_list").where("item_id", "==",val);
